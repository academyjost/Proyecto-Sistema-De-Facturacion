...
function cargarDatosDemo(){ 
    ...
    localStorage.clear(); 
    //guarda la lista de clientes prueba en el almacenamiento
    localStorage.setItem( 
        "clientes",
...
function cargarClientesVenta(){  
    //aqui se busca en el html el elemento de ventaCliente
    let combo = document.getElementById("ventaCliente"); 
    //limpieza
    combo.innerHTML = "";  
    //rrecorre el arreglo clientes
...
function cargarProductosVenta(){ 
    //Busca el venta prod para modificar
